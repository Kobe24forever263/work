...
|---|---:|---:|
| 成功率 | 96.83% | 96.00% |
| 原始episode平均回报 | 17.3364 | 16.9792 |
| 吞吐(任务/小时) | 56.606 | 56.704 |
| 平均仿真时间(s) | 1271.960 | 1269.744 |
| 非法动作 | 0 | 0 |
| 资源泄漏 | 0 | 0 |
...
- 条件选择矩阵：`{"CAR_DOG_CAR": {"CAR_DOG_CAR": 140, "SINGLE_DOG": 70}, "SINGLE_CAR": {"SINGLE_CAR": 300}, "SINGLE_DOG": {"SINGLE_DOG": 90}}`
- 各参考模式对角一致率：`{"CAR_DOG_CAR": 0.6666666666666666, "SINGLE_CAR": 1.0, "SINGLE_DOG": 1.0}`
