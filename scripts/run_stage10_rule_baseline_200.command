...
OUTPUT="$WORK_ROOT/results/stage10/stage10_rule_baseline_fixed_200.jsonl"
...
"$PYTHON" -u "$WORK_ROOT/scripts/run_stage10_rule_baseline.py" \
  --per-type 50 --seed 20260804 --output "$OUTPUT"
